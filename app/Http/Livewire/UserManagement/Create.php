...
class Create extends Component
{
    ...
    public function messages() {
        return [
            'passwordConfirmation.required' => __('user.The confirm password field is required'),
            'passwordConfirmation.same' => __('user.The Password and Confirm Password field do not match'),
        ];
    }
