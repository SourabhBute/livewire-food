...
class Edit extends Component
{
    ...
    public function messages() {
        return [
            "product.price.required" => __('product.The actual price field is required.'),
            "product.price_sale.numeric" => __('product.The sale price must be a number.'),
            "product.price.regex" => __('product.The actual price format is invalid.'),
        ];
    }
    ...
    public function mount($id){
        ...
        $this->product->price = number_format((double) $this->product->price, 2);
        $this->product->price_sale = number_format((double) $this->product->price_sale, 2);
