...
<x-siteprogress></x-siteprogress>
   ...
   @if (in_array(request()->route()->getName(),['payment.checkout','rtl','privacy-policy']))
    ...
    @elseif (in_array(request()->route()->getName(),['payment.checkout','privacy-policy','pricing-page','basic-lock', 'basic-reset', 'basic-sign-in', 'basic-sign-up','basic-verification','cover-lock', 'illustration-lock','cover-reset','illustration-reset','cover-sign-in','illustration-sign-in','cover-sign-up','illustration-sign-up','cover-verification','illustration-verification','error404','error500','register', 'login','forget-password','reset-password', 'otp-verification', 'change-password']))
        ...
        @if (in_array(request()->route()->getName(),['basic-reset','cover-sign-in', 'cover-verification','forget-password','cover-reset','otp-verification', 'change-password']))
