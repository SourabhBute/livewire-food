...
<div class="container {{ in_array(request()->route()->getName(),['illustration-sign-up','illustration-sign-in','illustration-reset','illustration-verification','illustration-lock','cover-lock','cover-sign-up']) ? 'ps-2 pe-0' : '' }}">
 ...
 <a class="navbar-brand font-weight-bolder  w-10 ms-lg-0 ms-3 d-flex flex-column text-center {{ in_array(request()->route()->getName(),['illustration-sign-up','illustration-sign-in','illustration-reset','illustration-verification','illustration-lock']) ? '' : 'text-white' }}">
