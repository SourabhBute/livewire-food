<aside
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @can('store-management', 'unverified-stores', 'store-type-management', 'cuisine-management')
                <li class="nav-item">
                        <a class="nav-link text-white {{ in_array(Route::currentRouteName(), ['store-management', 'unverified-stores', 'store-type-management', 'cuisine-management']) ? 'active' : ''  }}"
                        ...
                        <div class="collapse {{ in_array(Route::currentRouteName(), ['store-management', 'unverified-stores',  'store-type-management', 'cuisine-management']) ? 'show' : '' }} "
                            id="stores">
                   <ul class="nav nav-sm flex-column ms-2">
                    ...
                    @can('cuisine-management')
                    <li class="nav-item ">
                        <a class="nav-link text-white {{ strpos(Request::route()->uri(), 'cuisines') === false ? '' : 'active' }}" href="{{ route('cuisine-management') }}">
                            <span class="material-symbols-outlined">
                                Fastfood
                            </span>
                            <span class="sidenav-normal ms-2 ps-1">Cuisines</span>
                        </a>
                    </li>
                   @endcan  
