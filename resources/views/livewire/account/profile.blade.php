                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group input-group-static">
                                ...
                                <input wire:model.lazy="user.phone" type="number" class="form-control"
                                    placeholder="966 735 631 620"  @if(!$user->hasRole(['Admin'])) disabled @endif>
                            </div>
                            @error('user.phone')
                            <p class='text-danger inputerror'>{{ $message }} </p>
                            @enderror
                ...
                <div class="card-body pt-0">
                    <form wire:submit.prevent="passwordUpdate">
                        ...
                        <div class="input-group input-group-outline">
                            <input wire:model.lazy="old_password" type="password"  id="old_password" class="form-control rounded-3"
                                placeholder="Current Password">
                                <a class="material-symbols-outlined password-visibility"  onclick="showHidePassword('old_password', this)">
                                    visibility_off
                                </a>
                        </div>
                        @error('old_password')
                        ...
                        <div class="input-group input-group-outline mt-4">
                            <input wire:model.lazy='new_password' type="password" id="new_password" class="form-control rounded-3"
                                placeholder="New Password">
                                <a class="material-symbols-outlined password-visibility"  onclick="showHidePassword('new_password', this)">
                                    visibility_off
                                </a>
                        </div>
                        @error('new_password')
                        ...
                        @enderror
                        <div class="input-group input-group-outline mt-4">
                            <input wire:model="confirmationPassword" type="password" id="confirm_password" class="form-control rounded-3"
                                placeholder="Confirm New Password">
                                <a class="material-symbols-outlined password-visibility"  onclick="showHidePassword('confirm_password', this)">
                                    visibility_off
                                </a>
                        </div>
