                    ...
                    <div class="row">
                        <div class="col-md-12">            
                            ...
                            <div class="input-group input-group-static mt-4">
                                <input wire:model="confirmationPassword" id="myInput" type="password" class="form-control"
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-sm-0 mb-4">
                        <div class="w-50">
                            ...
                            <p class="text-sm mb-0">Once you suspended this account, It means that the user has remove temporarily.</p>
                        </div>
                        <div class="w-50 text-end">
                            <button wire:loading.attr="disabled"  class="btn bg-gradient-{{ $user->driver->account_status == 'suspended' ? 'success' : 'warning' }} mb-0 ms-2" type="button" name="button" wire:click="suspendedConfirm({{ $user  }})">{{ $user->driver->account_status == 'suspended' ? 'Re-Active Account' : 'Account suspended' }}</button>
                        </div>
                    </div>
                </div>
            </div>
