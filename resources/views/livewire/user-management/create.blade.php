                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-4">
                                <div class="input-group input-group-static" >
                                    ...
                                    <input  wire:model.lazy="password" type="password" id="password" autocomplete="new-password"  class="form-control" placeholder="Enter a Password">
                                    <a class="material-symbols-outlined password-visibility py-3" href="javascript:void(0)" onclick="showHidePassword('password', this)" aria-hidden="true">
                                        visibility_off
                                    </a>
                                </div>
                                @error('password')
                            ...
                            <div class="col-6 mb-4">
                                <div class="input-group input-group-static">
                                    ...
                                    <input wire:model.lazy="passwordConfirmation" id="password_confirm" type="password" class="form-control" placeholder="Enter a Confirm Password">
                                    <a class="material-symbols-outlined password-visibility py-3" href="javascript:void(0)" onclick="showHidePassword('password_confirm', this)" aria-hidden="true">
                                        visibility_off
                                    </a>
                                </div>
