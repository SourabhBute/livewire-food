                ...
                <div class="card-body pt-0">
                    ...
                    <div class="row mt-3">
                        <div class="col-12 col-sm-6">
                            ...
                            <select class="form-control px-2" wire:model.lazy="categories_ids"  id="projectName" onfocus="focused(this)" onfocusout="defocused(this)">
                        ...
                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                            <div class="input-group input-group-static">
                                <label>Tax</label>                        
                                <select class="form-control px-2 input-group input-group-dynamic"wire:model.lazy="tax_id"  id="projectName" onfocus="focused(this)" onfocusout="defocused(this)">
                    ...
                    <div class="row mt-3">
                        <div class="col-12 col-sm-12 mt-6 mt-sm-0">
                            <div class="input-group input-group-static demo">
                                <label>Store * </label>
                                <select class="form-control px-2 input-group input-group-dynamic select2" wire:model.lazy="store_id"  id="projectName" onfocus="focused(this)" onfocusout="defocused(this)">
                    ...
                    <div class="row mt-3">
                        <div class="col-12 col-sm-6">
                            <div class="input-group input-group-static">
                                ...
                                <input wire:model.lazy="price" class="multisteps-form__input form-control" type="text" placeholder="Enter a Actual Price" />
                            </div>
                            @error('price')
                            <p class='text-danger inputerror'>{{ $message }} </p>
                            @enderror
                        ...
                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                            <div class="input-group input-group-static">
                                ...
                                <input wire:model.lazy="price_sale" class="multisteps-form__input form-control" type="text" placeholder="Enter a Sale Price" />
                            </div>
                            @error('price_sale')
                            <p class='text-danger inputerror'>{{ $message }} </p>
                            @enderror
                    ...
                    <div class="row mt-3">
                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                            ...
                            dateFormat: 'Y-m-d H:i'});">
                                ...
                                <input wire:model.lazy="sale_start_date" id="from_date" x-ref="picker" class="form-control" type="text" placeholder="Enter a start sale date" />
                            </div>
                        ...
                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                            ...
                            dateFormat: 'Y-m-d H:i'});">
                                ...
                                <input wire:model.lazy="sale_end_date" id="to_date" x-ref="picker" class="form-control" type="text" placeholder="Enter a end sale date" />
                            </div>
                            @error('sale_end_date')
                            <p class='text-danger inputerror'>{{ $message }} </p>
                            @enderror
                            ...
                            <div class="col-md-12">
                                <div class="d-flex justify-content-end mt-4">
                                   ...
                                   <button wire:loading.attr="disabled" type="submit" name="submit" class="btn bg-gradient-dark m-0 ms-2">
                                    <span wire:loading.remove wire:target="store">Create Product</span>
