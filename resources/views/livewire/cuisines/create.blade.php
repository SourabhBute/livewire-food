                        ...
                        <div class="row ">
                            <div class="col-12 mb-4">
                                <div class="input-group input-group-static">
                                    <label>Name *</label>
                                    <input wire:model.lazy="name" type="text" class="form-control" placeholder="Enter a cuisine name">
                                </div>
                                @error('name')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="d-flex justify-content-end mt-4">
                                    ...
                                    <button type="submit" name="submit" wire:loading.attr="disabled" class="btn bg-gradient-dark m-0 ms-2">
                                        <span wire:loading.remove wire:target="store"> Create Cuisine</span>
