...
return [
    ...
    'Account is suspended successfully!' => 'Account is suspended successfully!',
    'If restored it, you will able to see this store data!' => 'If restored it, you will able to see this store data!',
    'Yes, restore it!' => 'Yes, restore it!',
    'Store Delete Successfully!' => 'Store Delete Successfully!',
    'The store details is already exist.please check stores list.'=>'The store details is already exist.please check stores list.',
    'The store details is already exist.please <a class="text-info" wire:click="restoreConfirm" href ="#">cilck here</a> to restore it.'=>'The store details is already exist.please <a class="text-info" wire:click="restoreConfirm" href ="#">cilck here</a> to restore it.',
    'Store successfully restored.' => 'Store successfully restored.',
    'Enable scheduler successfully updated.' => 'Enable scheduler successfully updated.',
    'Banner image changed successfully!' => 'Banner image changed successfully!'
