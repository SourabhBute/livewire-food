...
Route::group(['middleware' => ['auth', 'is-active']], function () {
    ...
    Route::get('products/category/edit/{id}/{ref_lang?}',  CategoryEdit::class)->name('edit-category');
    ...
    Route::get('products/tags/edit/{id}/{ref_lang?}', TagsEdit::class)->name('edit-product-tag');
